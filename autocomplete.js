...
function autocomplete(input, dictionary){
  ...
  for (let i = 0; i < dictionary.length; i++) {
    if (input === dictionary[i].slice(0, inputLength).toLowerCase()) {
...
console.log(autocomplete('#1aI*', ['airplane', 'apple', 'Airport', 'ball', 'airport', 'Airphone', 'Airflot', 'Airplane']));
console.log([ 'airplane', 'Airport', 'airport', 'Airphone', 'Airflot' ]);
